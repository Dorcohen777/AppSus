...
function _createNotes() {
    ...
    if (!notes || !notes.length) {
        notes = []
        notes.push(_createNoteText(5, '#F0A6CA'))
        ...
        notes.push(_createNoteText(20, '#A6E6E6'))
        notes.push(_createNoteText(20, '#F7DDA8'))
        notes.push(_createNoteVideo("If Programming Was An Anime", "pKO9UjSeLew"))
        notes.push(_createNoteText(50, '#C7CEEA'))
...
function _createNoteText(amount, color) {
    const textNote = {
